...
@section('content')
 <div id="pagepiling">
      ...
      <div class="section" id="section3" >
        ...
        <div class="section-sixth parallax to-left cont2" data-stellar-background-ratio="0.5"></div>
      </div>
      <div class="section" id="section4" >
        ...
        <div class="section-sixth parallax to-right cont3" data-stellar-background-ratio="0.5"></div>
      </div>
      <div class="section" id="section6" >
        ...
        <div class="section-sixth parallax to-left contact-map" data-stellar-background-ratio="0.5">
